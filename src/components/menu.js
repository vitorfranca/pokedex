...
const FLY_OUT_RADIUS = 100,
  SEPARATION_ANGLE = 120/(NUM_CHILDREN-1), //degrees
...
class APP extends React.Component {
  ...
  renderChildButtons() {
    ...
    const targetButtonStylesInitObject = range(0, NUM_CHILDREN).map(i => {
    ...
    const targetButtonStyles = range(0, NUM_CHILDREN).map(i => {
  ...
  render() {
    ...
    return (
      <div style={{position: 'fixed', bottom: MAIN_BUTTON_DIAM}}>
